# davidproud.uk — How to add your writing

*(One page. Keep this somewhere handy.)*

## To sign in
1. Go to **davidproud.uk/admin**
...
**Enter twice** for a gap between stanzas. What you see is what readers get.

## If anything goes wrong
Nothing you do can break the website — every change is saved and reversible.
If you're stuck, ring Asaf.
